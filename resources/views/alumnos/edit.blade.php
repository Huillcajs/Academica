...
<i class="fas fa-user-edit mr-3"></i> Editar Alumno: {{ $alumno->user->name }}
</h1>
...
<form action="{{ route('alumnos.update', $alumno->id) }}" method="POST" class="space-y-6">
    ...
    <div class="space-y-2">
        ...
        <input type="text" id="name" name="name" value="{{ old('name', $alumno->user->name) }}" required
    ...
    <div class="space-y-2">
        ...
        <input type="email" id="email" name="email" value="{{ old('email', $alumno->user->email) }}" required
            class="w-full px-4 py-3 bg-dark-bg border border-gray-700/50 rounded-lg text-gray-200 placeholder-gray-500 focus:ring-neon-blue focus:border-neon-blue transition duration-300"
    ...
    <div class="space-y-2">
        ...
        <input type="text" id="codigo" name="codigo" value="{{ old('codigo', $alumno->codigo) }}" required
            class="w-full px-4 py-3 bg-dark-bg border border-gray-700/50 rounded-lg text-gray-200 placeholder-gray-500 focus:ring-neon-blue focus:border-neon-blue transition duration-300"
    ...
    <div class="flex space-x-4 pt-4">
        <button type="submit" 
            class="flex-1 px-6 py-3 text-lg font-bold rounded-xl bg-neon-cyan text-dark-bg hover:bg-neon-cyan/80 transition duration-300 shadow-lg 
                   hover:shadow-[0_0_15px_rgba(0,255,255,0.8)] focus:outline-none focus:ring-4 focus:ring-neon-cyan/50">
            <i class="fas fa-sync-alt mr-2"></i> Actualizar Alumno
        </button>
